...
export class CreateServiceService {
    ...
    async createService(clusterId: string, userId: string, namespace: string = 'default', body: k8s.V1Service) {
        ...
        if (agentManager.isAgentConnected(clusterId)) {
            return await agentManager.executeTool(clusterId, 'create_service', { namespace, body });
        }
        ...
        return await servicesClient.createService(namespace, body);
    }
}
